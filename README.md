...
### 2. Interactive Hands-On Simulation Labs
* **🌨️ Collatz Hailstone Orbit Simulator**: Dynamic canvas trajectory rendering with glowing curves, peak altitude tracking, step counts, and cycle detection ($3n+1$, $5n+1$, $3n-1$).
...
### 3. 🤖 AI Co-Mathematician Exploration Lab
...
### 4. ⚡ 2021–2026 AI Mathematics Milestones
...
│   └── simulations.css          # Canvas layouts, scale, sieve, AI lab styles
└── js/
    ...
    ├── simulations/
    │   ├── collatz.js           # 3n+1 trajectory canvas & cycle visualizer
...
3. **From Margin Notes to Machine Certificates (Pioneers)**: Walk students from Fermat's 1637 handwritten note to Andrew Wiles's 1995 breakthrough, and finally to the September 2026 milestone where AI proved every deduction inside Lean 4.
